...
endpoint(::GitLabAPI, ::typeof(get_pull_request), owner::AStr, repo::AStr, number::Integer) =
...
endpoint(::GitLabAPI, ::typeof(update_pull_request), owner::AStr, repo::AStr, number::Integer) =
